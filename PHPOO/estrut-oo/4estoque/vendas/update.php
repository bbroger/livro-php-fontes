...
$sth = $pdo->prepare("SELECT * from vendas WHERE id = :id");
    ...
    <div class="panel panel-default">
        ...
        <div class="col-md-6">
            <form method="post" action="">
                ...
                <tr><td><b>Produto</td><td><?=$conn->combo('select id,descricao from produtos',$produto_id)?></td></tr>
                ...
                <tr><td><b>Data da Venda</td><td><input type="text" name="data_venda" value="<?=$data_venda?>"></td></tr>
