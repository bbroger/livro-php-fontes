...
$stmt = $tip->pdo->prepare("SELECT COUNT(*) FROM tips");
$stmt->execute();
$rows = $stmt->fetch();
...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading text-center"><h3><b><?=$conn->appNameIndex?> - Tips</h3></b></div>
        <div class="row">
                ...
                <form action="search.php" method="get" >
                  ...
                  <span class="pull-right">  
                    <label class="control-label" for="palavra" style="padding-right: 5px;">
                      <input type="text" value="" placeholder="Title or part" class="form-control" name="keyword">
                    </label>
