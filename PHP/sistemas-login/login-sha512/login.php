    ...
    <div class="container">
        ...
        <form method="post" action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>'>
            <div class="form-group">
                ...
                <input type="mail" placeholder="Email" class="form-control mb-2 mr-sm-2" name="email">
            </div>
            <div class="form-group">
                <label for="password">Password:</label>
                <input type="password" placeholder="" class="form-control mb-2 mr-sm-2" name="password">
            </div>
