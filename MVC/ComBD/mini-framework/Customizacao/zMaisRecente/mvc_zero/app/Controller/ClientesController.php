...
class ClientesController
{
    ...
    public function index()
    {
        ...
        $todos = $Cliente->todosClientes(); // Todos os clientes e seus dados
        $soma = $Cliente->somaClientes();// Total de clientes, a soma

        // Carregar a view. Com as views nós podemoms mostrar $todos e a soma facilmente
        require_once APP . 'templates/_includes/header.php';
        require_once APP . 'templates/clientes/index.php';
        require_once APP . 'templates/_includes/footer.php';
    }
    ...
    public function add()
    {
        ...
        // Carregar views.
        require_once APP . 'templates/_includes/header.php';
        require_once APP . 'templates/clientes/add.php';
        require_once APP . 'templates/_includes/footer.php';
    }
    ...
    public function edit($cliente_id)
    {
        ...
        if (isset($cliente_id)) {
            ...
            if ($um === false) {
                ...
                require_once APP . 'templates/_includes/header.php';
                require_once APP . 'templates/clientes/edit.php';
                require_once APP . 'templates/_includes/footer.php';
            }
        } else {
