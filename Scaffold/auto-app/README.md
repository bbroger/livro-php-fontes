...
## Esclarecimento
Este código é indicado para criar um aplicativo de forma rápida, mas como seu código é complexo não é indicado para aplicativos que precisarão de ajustes e alterações.
