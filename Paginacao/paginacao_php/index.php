...
<html>
<head>
    <title>Paginação Simples com PDO</title>
...
<body>
    ...
    <div class="container">
		...
		$query = "SELECT id, nome, email, nascimento, cpf FROM clientes ORDER BY id
		...
		echo "<a href='create.php' class='btn btn-primary m-b-1em'>Novo Cliente</a>";
