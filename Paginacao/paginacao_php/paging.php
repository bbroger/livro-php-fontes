...
if($page>1){
    ...
    echo "<li>";
        echo "<a href='{$page_url}page=1'>";
            echo "<span style='margin:0 .5em;'>Primeiro</span>";
        echo "</a>";
    echo "</li>";
...
// range of num links to show - total de links por página
$range = 10	;
...
if($page<$total_pages){
    ...
    echo "<li>";
        echo "<a href='{$page_url}page={$total_pages}'>";
            echo "<span style='margin:0 .5em;'>Último</span>";
        echo "</a>";
    echo "</li>";
